...
import { Home, CreditCard, ArrowLeftRight, PiggyBank, User, LogOut, Bell, Search } from "lucide-react";
    ...
    <div className="flex h-screen bg-background text-foreground overflow-hidden selection:bg-primary/30">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-border bg-sidebar/50 backdrop-blur-xl">
        <div className="p-6 flex items-center gap-3">
          ...
          <span className="font-display font-bold tracking-wide text-xl">NeoBank</span>
        </div>
        ...
        <div className="p-4 border-t border-border mt-auto">
          <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all w-full">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-background/90 backdrop-blur-xl border-t border-border flex items-center justify-around px-2 h-16 pb-safe z-50">
